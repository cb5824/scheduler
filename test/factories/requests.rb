FactoryBot.define do
  factory :request do
    ...
    approval4 {"pending"}
    archived {"no"}
    monday_hash{{"start_time"=>"01:00", "end_time"=>"02:00", "cp1"=>1, "cp2"=>7, "mp1"=>2, "mp2"=>3, "MT1"=>1, "MT2"=>1, "MT3"=>1, "MT4"=>1, "taw"=>1, "form_b"=>1, "form_c"=>1, "track_and_time"=>1, "single_track"=>"multi", "worker_primary"=>"A", "worker_secondary1"=>"X", "worker_secondary2"=>"Q", "worker_secondary3"=>"none", "worker_secondary4"=>"none", "worker_secondary5"=>"none", "cancelled"=>"no", "other"=>0, "inacc_track"=>0, "b_time"=>"", "b_location"=>"", "onsite_name"=>"", "onsite_number"=>"" }}
    tuesday_hash{{"start_time"=>"", "end_time"=>"", "cp1"=>1, "cp2"=>1, "mp1"=>"", "mp2"=>"", "MT1"=>0, "MT2"=>0, "MT3"=>0, "MT4"=>0, "taw"=>0, "form_b"=>0, "form_c"=>0, "track_and_time"=>0, "worker_primary"=>"none", "worker_secondary1"=>"none", "worker_secondary2"=>"none", "worker_secondary3"=>"none", "worker_secondary4"=>"none", "worker_secondary5"=>"none", "other"=>0, "inacc_track"=>0, "b_time"=>"", "b_location"=>"", "onsite_name"=>"", "onsite_number"=>"" }}
    wednesday_hash{{"start_time"=>"01:00", "end_time"=>"02:00", "cp1"=>1, "cp2"=>7, "mp1"=>2, "mp2"=>3, "MT1"=>1, "MT2"=>1, "MT3"=>1, "MT4"=>1, "taw"=>1, "form_b"=>1, "form_c"=>1, "track_and_time"=>1, "single_track"=>"multi", "worker_primary"=>"A", "worker_secondary1"=>"X", "worker_secondary2"=>"Q", "worker_secondary3"=>"none", "worker_secondary4"=>"none", "worker_secondary5"=>"none", "cancelled"=>"no", "other"=>0, "inacc_track"=>0 , "b_time"=>"", "b_location"=>"", "onsite_name"=>"", "onsite_number"=>"" }}
    thursday_hash{{"start_time"=>"", "end_time"=>"", "cp1"=>1, "cp2"=>1, "mp1"=>"", "mp2"=>"", "MT1"=>0, "MT2"=>0, "MT3"=>0, "MT4"=>0, "taw"=>0, "form_b"=>0, "form_c"=>0, "track_and_time"=>0, "worker_primary"=>"none", "worker_secondary1"=>"none", "worker_secondary2"=>"none", "worker_secondary3"=>"none", "worker_secondary4"=>"none", "worker_secondary5"=>"none", "cancelled"=>"no", "other"=>0, "inacc_track"=>0, "b_time"=>"", "b_location"=>"", "onsite_name"=>"", "onsite_number"=>"" }}
